...
export const OLD_BALLERINA_VERSION: string = "Your Ballerina version does not match the Compiler Toolkit VSCode plugin version. Some features may not work properly. Please download the latest Ballerina distribution.";

...
const outputChannel = vscode.window.createOutputChannel("Ballerina Compiler Toolkit");
const logLevelDebug: boolean = vscode.workspace.getConfiguration("ballerinaCompilerToolkit").get("debugLog") === true;
